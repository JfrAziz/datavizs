    ...
    <div className="space-y-2">
      <ConfigSection label="Chart Layout">
        <div className="flex flex-wrap">
          ...
          />
          <SegmentedControlExtended<"id" | "indexValue">
            label="Color Mode"
            description="How the color generated by"
            defaultValue="id"
            value={config.colorBy}
            data={[
              { value: "id", label: "group" },
              { value: "indexValue", label: "bar" },
            ]}
            onChange={(value) => setConfig({ colorBy: value })}
          />
      ...
      <ConfigSection label="Chart Padding">
        <div className="flex items-start space-x-2">
          <SliderExtended
            label="Padding"
            className="flex-1"
            description="Padding between each group"
            min={0}
            max={1}
            step={0.1}
            defaultValue={0.2}
